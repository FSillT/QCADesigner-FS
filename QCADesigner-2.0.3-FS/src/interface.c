...
void create_main_window (main_W *main_window){
  ...
  GtkWidget
    ...
    *translate_selection_button      = NULL, *view_menu                 = NULL, *hide_layers_menu_item             = NULL,
    ////////////// Dayane Alfenas Reis - 09/10/14 - 09:48am
    *fault_simulation_setup_menu_item  = NULL,
    *fault_simulation_start_menu_item  = NULL,
    *fault_simulation_results_menu_item  = NULL,
    *show_USE_clocking_scheme_menu_item= NULL,
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  USE_clocking_scheme_setup_menu_item = gtk_menu_item_new_with_mnemonic (_("Configure USE Clocking Scheme Size..."));
  gtk_widget_show (USE_clocking_scheme_setup_menu_item);
  gtk_container_add (GTK_CONTAINER (edit_menu_menu), USE_clocking_scheme_setup_menu_item);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  // create and add a separator to the view menu //
  mnuiSep = gtk_menu_item_new ();
  gtk_widget_show (mnuiSep);
  ...
  // Dayane Alfenas Reis - 10/14/14 - 11:02AM
  ...
  // create and add the Show USE Clocking Scheme menu item to the view menu //
  show_USE_clocking_scheme_menu_item = gtk_check_menu_item_new_with_label (_("Show USE Clocking Scheme"));
  gtk_widget_show (show_USE_clocking_scheme_menu_item);
  gtk_container_add (GTK_CONTAINER (view_menu_menu), show_USE_clocking_scheme_menu_item);
  gtk_check_menu_item_set_active (GTK_CHECK_MENU_ITEM (show_USE_clocking_scheme_menu_item), FALSE);
  gtk_check_menu_item_set_show_toggle (GTK_CHECK_MENU_ITEM(show_USE_clocking_scheme_menu_item), FALSE);

  // End of Dayane Alfenas Reis - 10/14/14 - 11:02AM
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  // create and add a separator to the simulation menu //
  mnuiSep = gtk_menu_item_new ();
  gtk_widget_show (mnuiSep);
  gtk_container_add (GTK_CONTAINER (simulation_menu_menu), mnuiSep);
  gtk_widget_set_sensitive (mnuiSep, FALSE);
  ...
  ////////////// Dayane Alfenas Reis - 29/09/14 - 01:01pm
  ...
  // create and add the start fault simulation menu item to the simulation menu //
  fault_simulation_start_menu_item = gtk_menu_item_new_with_mnemonic (_("Error Exploration Start"));
  gtk_widget_show (fault_simulation_start_menu_item);
  gtk_container_add (GTK_CONTAINER (simulation_menu_menu), fault_simulation_start_menu_item);

  // create and add the fault simulation menu item to the simulation menu //
  fault_simulation_setup_menu_item = gtk_menu_item_new_with_mnemonic (_("Error Exploration Settings..."));
  gtk_widget_show (fault_simulation_setup_menu_item);
  gtk_container_add (GTK_CONTAINER (simulation_menu_menu), fault_simulation_setup_menu_item);

  // create and add the read files from fault simulation menu item to the simulation menu //
  //fault_simulation_results_menu_item = gtk_menu_item_new_with_mnemonic (_("Fault Simulation Results..."));
  //gtk_widget_show (fault_simulation_results_menu_item);
  //gtk_container_add (GTK_CONTAINER (simulation_menu_menu), fault_simulation_results_menu_item);
...
////////////////////////////////////////////////////////////////////////////////////////
  ...
  ////////////// Dayane Alfenas Reis - 14/10/14 - 11:10am
  g_signal_connect (G_OBJECT (show_USE_clocking_scheme_menu_item),             "activate", (GCallback)on_show_USE_clocking_scheme_menu_item_activate,NULL);
  g_signal_connect (G_OBJECT (USE_clocking_scheme_setup_menu_item),            "activate", (GCallback)on_USE_clocking_scheme_setup_menu_item_activate,NULL);
  ////////////// End of Dayane Alfenas Reis - 14/10/14 - 11:10am
  ...
  ////////////// Dayane Alfenas Reis - 09/10/14 - 09:48am
  g_signal_connect (G_OBJECT (fault_simulation_setup_menu_item),               "activate", (GCallback)on_fault_simulation_setup_menu_item_activate,  NULL);
  g_signal_connect (G_OBJECT (fault_simulation_results_menu_item),             "activate", (GCallback)on_fault_simulation_results_menu_item_activate,NULL);
  g_signal_connect (G_OBJECT (fault_simulation_start_menu_item),               "activate", (GCallback)on_fault_simulation_start_menu_item_activate,  NULL);
  ////////////// End of Dayane Alfenas Reis - 09/10/14 - 09:48am
